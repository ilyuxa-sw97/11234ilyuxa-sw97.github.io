...
## Mixed language
### Please, not copy this text into your LICENSE file
### Пожалуйста, не копируйте данный текст в ваш файл лицензии LICENSE

```
 This is is an unofficial translation of the GNU General Public License
 into Russian. It was not published by the Free Software Foundation,
 ...
 распространения программного обеспечения, которое распространяется на условиях
 ...
 Общественной Лицензии GNU на английском языке. Мы надеемся, что настоящий
